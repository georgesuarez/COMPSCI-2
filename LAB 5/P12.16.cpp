/*
        Implement a Queue class, using a linked list of strings. Supply
   operations size, push, pop, front, and back, just like in the standard stack
   template.
*/
...
int Queue::size() { return sizeOfQueue; }
