...
inline int Fraction::gcd(int n, int m)
{
...
{
    Fraction result(left.numerator() * right.denominator() + right.numerator() * left.denominator(),
...
inline int Fraction::compare(const Fraction &right) const
{
...
{
    int t = value.numerator();
    int b = value.denominator();
