/*
   ...
   two constructors: one with an apartment number and one without. Supply a
   print function that prints the address with the street on one line and the
   city, state, and postal code on the next line. Supply a member function
   comes_before that tests whether one address comes before another when the
...
public:
  ...
  Address(int house_num, string street, string city, string state,
          string postal_code);

  Address(int house_num, string street, int apartment_num, string city,
...
Address::Address(int new_house_num, string new_street, string new_city,
                 string new_state, string new_postal_code) {
...
Address::Address(int new_house_num, string new_street, int new_apartment_num,
                 string new_city, string new_state, string new_postal_code) {
  house_num = new_house_num;
  street = new_street;
...
int main() {
  ...
  cout << "Postal Code: " << address1.comes_before(address2) << " comes first."
       << endl;
