/*
   ...
   the user for the values of r and h, calls the six functions, and prints the
   results.
*/
...
double sphere_volume(double r) { return (4.0 / 3.0) * PI * pow(r, 3); }

double sphere_surface(double r) { return 4.0 * PI * pow(r, 2); }

double cylinder_volume(double r, double h) { return PI * pow(r, 2) * h; }
