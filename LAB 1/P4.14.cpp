/*
        ...
        for input whenever a decision needs to be made. Decompose each task into
...
void coffee_choice();
// coffee_choice - check if the user wants to use coffee beans or already has
// coffee ground
...
void clean_coffee_maker() {
  ...
  cout << "Pour the vinegar inside the coffee maker through the coffee filter."
       << endl;
...
void brew_coffee() {
  ...
  if (input == "y") {
    ...
    cout << "Then collect your coffee from the coffee maker, and enjoy."
         << endl;
  }
}
...
void grind_coffee() {
  ...
  cout << "Wait until the coffee grinder is done, and then collect your coffee "
          "ground."
       << endl;
}
